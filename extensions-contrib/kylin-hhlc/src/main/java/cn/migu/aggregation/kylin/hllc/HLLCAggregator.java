 ...
 **/
public class HHLCAggregator implements Aggregator
{
    ...
    public HHLCAggregator(ObjectColumnSelector selector, Integer precision)
    {
    ...
    @Override public float getFloat()
    {
        throw new UnsupportedOperationException(
                "HHLCAggregator does not support getFloat()");
    }

    @Override public long getLong()
    {
        throw new UnsupportedOperationException(
                "HHLCAggregator does not support getLong()");
    }
