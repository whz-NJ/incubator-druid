 ...
 **/
public class HHLCBufferAggregator implements BufferAggregator
{
    ...
    public HHLCBufferAggregator(ObjectColumnSelector selector, int precision)
    {
    ...
    @Override public float getFloat(ByteBuffer buf, int position)
    {
        throw new UnsupportedOperationException(
                "HHLCBufferAggregator does not support getFloat()");
    }

    @Override public long getLong(ByteBuffer buf, int position)
    {
        throw new UnsupportedOperationException(
                "HHLCBufferAggregator does not support getLong()");
    }
